...
from .adaptive_suggestion_views import AdaptiveSuggestionViewSet
...
# Adaptive Suggestions (NEW)
router.register(r'adaptive-suggestions', AdaptiveSuggestionViewSet, basename='adaptive-suggestion')
